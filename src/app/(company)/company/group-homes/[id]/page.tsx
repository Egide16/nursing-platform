...
export default async function GroupHomeDetail({ params }: { params: { id: string } }) {
  ...
  if (!home || home.companyId !== session.user.companyId) notFound();

  const addClientWithId = addClient.bind(null, home.id);

  return (
    <div className="max-w-lg mx-auto px-6 py-10">
      <h1 className="serif text-xl text-ink">{home.name}</h1>
