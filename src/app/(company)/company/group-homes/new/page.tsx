  ...
  return (
    <div className="max-w-md mx-auto px-6 py-10">
      ...
      <form action={createGroupHome} className="flex flex-col gap-3">
        <input name="name" required placeholder="e.g. 12 Birch St" className="px-4 py-3 border border-line text-sm" />
        <input name="address" placeholder="Full address (optional)" className="px-4 py-3 border border-line text-sm" />
